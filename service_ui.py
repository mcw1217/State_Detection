...
from service import get_model, do_service
import numpy as np
...
#     global temp_data
#     img_data.append(img)
#     temp_data.append(gTemp)
#     print("a")
#     if len(img_data) & len(temp_data) >= 5:
#         model = get_model()
#         result = do_service(img_data, temp_data, model)
#         print(result,"값")
#         return result
#     else:
#         return "None"
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # label_text = QLabel("hello", self)
        # label_text.setAlignment(Qt.AlignCenter)
        # font1 = label_text.font()
    ...
    def runThread(self):
        ...
        # -------------------thermal
        self.thread_thermal = ThermalThread()
